...
let newcards: ImageContainProps[] = [
  ...
  },
  {
    ...
    img320: "/assets/imgagentstudio.webp",
    button: "Learn more ",
    link: "product/AppStudio/",
...
const cards = [

  {
    ...
    image: "/assets/slider/CustomerSatisfactionwithAgentStudio_Slider.webp",
    moreText: "Learn more",
