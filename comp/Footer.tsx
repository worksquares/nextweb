          ...
          <div className={styles.footermaincontent}> 
            <div className={styles.footerblogs}>
              ...
              <div className={styles.footerblogsfirst}>
                <img className={styles.footerImg} width="200px" height="200px" src="/assets/DigiLogo.webp" alt="Company name" />
                <div className={styles.footerInfo}>
                  <p style={{color:"#777777"}}>Our mission is to empower users to easily turn great ideas into powerful business applications with less resources and time.</p>
                  <div className={styles.footerblogimg}>
                    <Link legacyBehavior href="https://www.facebook.com/digisquares/">
                      <a>
                    ...
                    <Link legacyBehavior href="https://www.youtube.com/channel/UC10Kqzxy547k75Kbnz-12hA/featured">
                      <a>
                        <span className={styles.footerHeading}>Youtube</span>
                        <svg fill="currentColor" height="100%" version="1.1" viewBox="0 0 512 512" width="100%" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <Link legacyBehavior href="https://in.linkedin.com/company/digisquares?trk=public_profile_experience-item_profile-section-card_subtitle-click">
                      <a>
              ...
              <div className={styles.footerblogsec}>
                ...
                <div>
                  ...
                  <ul className={styles.footersolul}>
                    ...
                    <li>
                      <Link legacyBehavior href="/solutions/LegacyModernization/">
                        <a>Legacy Modernization</a>
                      </Link>
                    </li>

                    <li>
                      <Link legacyBehavior href="/solutions/CustomerExperience/">
                ...
                <div>
                  ...
                  <ul className={styles.footersolul}>
                    <li>
                      <Link legacyBehavior href="/platform/DigisquaresPlatform/">
                    ...
                    <li>
                      <Link legacyBehavior href="/platform/WorkflowDevelopment/">
