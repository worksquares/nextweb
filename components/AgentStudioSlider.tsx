...
import styles from "../styles/comp/AgentStudioSlider.module.css"; // Or create a new CSS module
...
const AgentStudioSlider = ({ cards, autoplay = true, speed = 2000 }: AgentStudioProps) => {
...
export default AgentStudioSlider;
