...
import styles from "../styles/comp/AppStudioSlider.module.css"; // Or create a new CSS module
...
const AppStudioSlider = ({ cards, autoplay = true, speed = 2000 }: AppSliderProps) => {
...
export default AppStudioSlider;
